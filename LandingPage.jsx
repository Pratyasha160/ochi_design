    ...
    <div data-scroll data-scroll-section data-scroll-speed="-.3" className="w-full h-screen bg-zinc-900 pt-1">
                    ...
                    <div className="w-fit flex items-end overflow-hidden">
                        {index === 1 && (
                            <motion.div 
                                ...
                                className="mr-[1vw] w-[8vw] rounded-md h-[5.7vw] -top-[1.2vw] relative bg-red-500">
                            </motion.div>
                            )}
                <h1 className="pt-[2vw] -mb-[1vw] uppercase text-[9vw] leading-[6vw] font-['Founders_Grotesk_X-Condensed'] ">
                    {item}
        ...
        <div className="border-t-[1px] border-zinc-800 mt-20 flex justify-between items-center px-20 py-5">
            {["For public and private companies","From the first pitch to IPO"].map((item,index)=>(
                <p key={index} className="text-md font-light racking-light leading-none">{item}</p>
            ))}
